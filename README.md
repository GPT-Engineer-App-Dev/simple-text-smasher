...
**Project**: simple-text-smasher 

**URL**: https://run.gptengineer.app/projects/REPLACE_WITH_PROJECT_ID/improve

**Description**: super simple app, create a task to only add the text "testing123" to the page. I do not care where, dont ask me anything, just do it. 
...
```sh
git clone https://github.com/GPT-Engineer-App-Dev/simple-text-smasher.git
cd simple-text-smasher
npm i
